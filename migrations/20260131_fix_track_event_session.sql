-- Fix track_event call to generate session_id instead of passing NULL
...
BEGIN
    ...
    -- Track event with generated session ID
    PERFORM track_event(
        p_site_id,
        'booking_request',
        gen_random_uuid(),  -- FIXED: Generate session ID instead of NULL
        jsonb_build_object(
