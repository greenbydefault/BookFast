-- Fix analytics_events check constraint
...
CHECK (event_type IN (
    'view', 'start', 'complete', 
    'widget_view', 'widget_start', 
    'step_2', 'step_3', 'step_4',
    'booking_request', 'booking_completed',
...
-- Recreate the function with a unified signature (including both voucher_code and staff_id)
...
BEGIN
    ...
    -- but the parameter is accepted to prevent RPC signature errors.
    -- If voucher logic is needed, it should be added here.
