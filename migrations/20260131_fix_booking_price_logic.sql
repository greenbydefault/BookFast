-- Recreate the function with fixed price calculation logic
...
BEGIN
    ...
    -- This is needed because the constraints expect total_price = service_price + addons_price - discount
    ...
    -- Note: Voucher logic is not yet implemented in this function body.
    -- If implemented, discount_amount should be calculated and subtracted from v_total_price.
    ...
    INSERT INTO bookings (
        ...
        customer_notes,
        status,
        service_price,  -- Insert component price
        addons_price,   -- Insert component price
        discount_amount, -- Insert component price (default 0)
        total_price
    ) VALUES (
        v_workspace_id,
        p_object_id,
