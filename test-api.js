...
async function main() {
    ...
    console.log('Sites result:', sites.length > 0 ? sites[0].id : 'No sites found');
    ...
    if (!widget || !widget.objects || widget.objects.length === 0) {
    ...
    if (avail && avail.bookings && avail.bookings.length > 0) {
        console.log('Example booking item:', JSON.stringify(avail.bookings[avail.bookings.length - 1], null, 2));
