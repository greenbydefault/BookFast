-- Include vacations in get_availability_for_range blocked_dates
-- workspace scope: blocks all objects in that workspace
-- object scope: blocks only the specific object
-- staff/service scope: requires API extension (not in this migration)
...
-- 4-arg overload (with p_session_id)
CREATE OR REPLACE FUNCTION public.get_availability_for_range(
