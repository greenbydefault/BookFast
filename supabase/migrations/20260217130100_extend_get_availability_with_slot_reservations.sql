-- Extend get_availability_for_range to include active slot_reservations as blocked time ranges
-- Format matches bookings: {date, start_time, end_time} so embed's genSlots works without changes
