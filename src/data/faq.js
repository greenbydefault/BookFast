...
export const SHARED_FAQ = [
  ...
  { question: 'Was kostet BookFast?', answer: 'Ab 9,49 €/Monat (Starter, 1 Workspace). Alle Pläne enthalten dieselben Features – nur die Anzahl der Workspaces unterscheidet sich. 0 % Provision pro Buchung.' },
