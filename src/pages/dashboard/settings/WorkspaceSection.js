...
const getWebflowTemplate = () => {
  ...
  const nodes = [
    ...
    { "_id": ids.splitHeader, "tag": "div", "classes": c('bf-split-header'), "children": [ids.splitHeaderName, ids.splitHeaderSub], "type": "Block", "data": { "tag": "header" } },
    { "_id": ids.splitHeaderName, "tag": "h2", "classes": c('bf-split-header-name'), "children": [ids.splitHeaderNameText], "type": "Heading", "data": { "tag": "h2", "attr": { "data-bf-display": "workspace-name", "data-bf-step-title": "true", "data-bf-part": "workspace-name" } } },
    { "_id": ids.splitHeaderNameText, "text": true, "v": "Buchung" },
    { "_id": ids.splitHeaderSub, "tag": "p", "classes": c('bf-split-header-sub'), "children": [ids.splitHeaderSubText], "type": "Paragraph", "data": { "tag": "p" } },
    ...
    // Card: Object
    { "_id": ids.cardObj, "tag": "div", "classes": c('bf-split-card').concat(c('bf-split-card-open')), "children": [ids.cardObjHeader, ids.cardObjBody], "type": "Block", "data": { "tag": "article", "attr": { "data-bf-card": "object", "data-bf-part": "card" } } },
    { "_id": ids.cardObjHeader, "tag": "button", "classes": c('bf-split-card-header'), "children": [ids.cardObjNum, ids.cardObjInfo, ids.cardObjArrow], "type": "Block", "data": { "tag": "button", "attr": { "type": "button", "aria-expanded": "true", "data-bf-part": "card-header" } } },
    { "_id": ids.cardObjNum, "tag": "span", "classes": c('bf-split-card-num'), "children": [ids.cardObjNumText], "type": "Block", "data": { "tag": "span", "attr": { "data-bf-part": "card-num" } } },
    { "_id": ids.cardObjNumText, "text": true, "v": "1" },
    { "_id": ids.cardObjInfo, "tag": "div", "classes": c('bf-split-card-info'), "children": [ids.cardObjTitle, ids.cardObjDesc], "type": "Block", "data": { "tag": "div", "attr": { "data-bf-part": "card-info" } } },
    { "_id": ids.cardObjTitle, "tag": "h3", "classes": c('bf-split-card-title'), "children": [ids.cardObjTitleText], "type": "Heading", "data": { "tag": "h3", "attr": { "data-bf-part": "card-title" } } },
    { "_id": ids.cardObjTitleText, "text": true, "v": "Objekt" },
    { "_id": ids.cardObjDesc, "tag": "p", "classes": c('bf-split-card-desc'), "children": [ids.cardObjDescText], "type": "Paragraph", "data": { "tag": "p", "attr": { "data-bf-part": "card-desc" } } },
    { "_id": ids.cardObjDescText, "text": true, "v": "Wähle das Objekt aus" },
    { "_id": ids.cardObjArrow, "tag": "span", "classes": c('bf-split-card-arrow').concat(c('bf-split-card-arrow-open')), "children": [ids.cardObjArrowSvg], "type": "Block", "data": { "tag": "span", "attr": { "data-bf-part": "card-arrow" } } },
    ...
    { "_id": ids.cardObjBody, "tag": "div", "classes": c('bf-split-card-body').concat(c('bf-split-card-body-open')), "children": [ids.objDynamic], "type": "Block", "data": { "tag": "div", "attr": { "data-bf-panel": "object", "data-bf-part": "card-panel" } } },
    ...
    { "_id": ids.objSample, "tag": "article", "classes": c('bf-template-item'), "children": [ids.objSampleMain, ids.objSampleMeta], "type": "Block", "data": { "tag": "article", "attr": { "data-bf-template": "object-item", "data-bf-part": "object-item" } } },
    { "_id": ids.objSampleMain, "tag": "div", "classes": [], "children": [ids.objSampleTitle, ids.objSampleSub], "type": "Block", "data": { "tag": "div", "attr": { "data-bf-part": "object-main" } } },
    { "_id": ids.objSampleTitle, "tag": "h4", "classes": c('bf-template-item-title'), "children": [ids.objSampleTitleText], "type": "Heading", "data": { "tag": "h4", "attr": { "data-bf-part": "object-name" } } },
    { "_id": ids.objSampleTitleText, "text": true, "v": "Beispiel Objekt" },
    { "_id": ids.objSampleSub, "tag": "p", "classes": c('bf-template-item-sub'), "children": [ids.objSampleSubText], "type": "Paragraph", "data": { "tag": "p", "attr": { "data-bf-part": "object-desc" } } },
    { "_id": ids.objSampleSubText, "text": true, "v": "Adresse oder Beschreibung" },
    { "_id": ids.objSampleMeta, "tag": "small", "classes": c('bf-template-item-sub'), "children": [ids.objSampleMetaText], "type": "Block", "data": { "tag": "small", "attr": { "data-bf-part": "object-capacity" } } },
    { "_id": ids.objSampleMetaText, "text": true, "v": "Max. 4 Gäste" },

    // Card: Service
    { "_id": ids.cardSvc, "tag": "div", "classes": c('bf-split-card'), "children": [ids.cardSvcHeader, ids.cardSvcBody], "type": "Block", "data": { "tag": "article", "attr": { "data-bf-card": "service", "data-bf-part": "card" } } },
    { "_id": ids.cardSvcHeader, "tag": "button", "classes": c('bf-split-card-header'), "children": [ids.cardSvcNum, ids.cardSvcInfo, ids.cardSvcArrow], "type": "Block", "data": { "tag": "button", "attr": { "type": "button", "aria-expanded": "false", "data-bf-part": "card-header" } } },
    { "_id": ids.cardSvcNum, "tag": "span", "classes": c('bf-split-card-num'), "children": [ids.cardSvcNumText], "type": "Block", "data": { "tag": "span", "attr": { "data-bf-part": "card-num" } } },
    { "_id": ids.cardSvcNumText, "text": true, "v": "2" },
    { "_id": ids.cardSvcInfo, "tag": "div", "classes": c('bf-split-card-info'), "children": [ids.cardSvcTitle, ids.cardSvcDesc], "type": "Block", "data": { "tag": "div", "attr": { "data-bf-part": "card-info" } } },
    { "_id": ids.cardSvcTitle, "tag": "h3", "classes": c('bf-split-card-title'), "children": [ids.cardSvcTitleText], "type": "Heading", "data": { "tag": "h3", "attr": { "data-bf-part": "card-title" } } },
    { "_id": ids.cardSvcTitleText, "text": true, "v": "Service" },
    { "_id": ids.cardSvcDesc, "tag": "p", "classes": c('bf-split-card-desc'), "children": [ids.cardSvcDescText], "type": "Paragraph", "data": { "tag": "p", "attr": { "data-bf-part": "card-desc" } } },
    { "_id": ids.cardSvcDescText, "text": true, "v": "Wähle den Service aus" },
    { "_id": ids.cardSvcArrow, "tag": "span", "classes": c('bf-split-card-arrow'), "children": [ids.cardSvcArrowSvg], "type": "Block", "data": { "tag": "span", "attr": { "data-bf-part": "card-arrow" } } },
    ...
    { "_id": ids.cardSvcBody, "tag": "div", "classes": c('bf-split-card-body'), "children": [ids.svcDynamic], "type": "Block", "data": { "tag": "div", "attr": { "data-bf-panel": "service", "data-bf-part": "card-panel" } } },
    ...
    { "_id": ids.svcSample, "tag": "article", "classes": c('bf-template-item'), "children": [ids.svcSampleMain, ids.svcSampleMeta], "type": "Block", "data": { "tag": "article", "attr": { "data-bf-template": "service-item", "data-bf-part": "service-item" } } },
    { "_id": ids.svcSampleMain, "tag": "div", "classes": [], "children": [ids.svcSampleTitle, ids.svcSampleSub], "type": "Block", "data": { "tag": "div", "attr": { "data-bf-part": "service-main" } } },
    { "_id": ids.svcSampleTitle, "tag": "h4", "classes": c('bf-template-item-title'), "children": [ids.svcSampleTitleText], "type": "Heading", "data": { "tag": "h4", "attr": { "data-bf-part": "service-name" } } },
    { "_id": ids.svcSampleTitleText, "text": true, "v": "Beispiel Service" },
    { "_id": ids.svcSampleSub, "tag": "p", "classes": c('bf-template-item-sub'), "children": [ids.svcSampleSubText], "type": "Paragraph", "data": { "tag": "p", "attr": { "data-bf-part": "service-time" } } },
    { "_id": ids.svcSampleSubText, "text": true, "v": "09:00-12:00 Uhr" },
    { "_id": ids.svcSampleMeta, "tag": "small", "classes": c('bf-template-item-sub'), "children": [ids.svcSampleMetaText], "type": "Block", "data": { "tag": "small", "attr": { "data-bf-part": "service-meta" } } },
    { "_id": ids.svcSampleMetaText, "text": true, "v": "120 Min. - EUR 49" },

    // Card: Staff
    { "_id": ids.cardStaff, "tag": "div", "classes": c('bf-split-card'), "children": [ids.cardStaffHeader, ids.cardStaffBody], "type": "Block", "data": { "tag": "article", "attr": { "data-bf-card": "staff", "data-bf-part": "card" } } },
    { "_id": ids.cardStaffHeader, "tag": "button", "classes": c('bf-split-card-header'), "children": [ids.cardStaffNum, ids.cardStaffInfo, ids.cardStaffArrow], "type": "Block", "data": { "tag": "button", "attr": { "type": "button", "aria-expanded": "false", "data-bf-part": "card-header" } } },
    { "_id": ids.cardStaffNum, "tag": "span", "classes": c('bf-split-card-num'), "children": [ids.cardStaffNumText], "type": "Block", "data": { "tag": "span", "attr": { "data-bf-part": "card-num" } } },
    { "_id": ids.cardStaffNumText, "text": true, "v": "3" },
    { "_id": ids.cardStaffInfo, "tag": "div", "classes": c('bf-split-card-info'), "children": [ids.cardStaffTitle, ids.cardStaffDesc], "type": "Block", "data": { "tag": "div", "attr": { "data-bf-part": "card-info" } } },
    { "_id": ids.cardStaffTitle, "tag": "h3", "classes": c('bf-split-card-title'), "children": [ids.cardStaffTitleText], "type": "Heading", "data": { "tag": "h3", "attr": { "data-bf-part": "card-title" } } },
    { "_id": ids.cardStaffTitleText, "text": true, "v": "Mitarbeiter" },
    { "_id": ids.cardStaffDesc, "tag": "p", "classes": c('bf-split-card-desc'), "children": [ids.cardStaffDescText], "type": "Paragraph", "data": { "tag": "p", "attr": { "data-bf-part": "card-desc" } } },
    { "_id": ids.cardStaffDescText, "text": true, "v": "Wähle deinen Mitarbeiter" },
    { "_id": ids.cardStaffArrow, "tag": "span", "classes": c('bf-split-card-arrow'), "children": [ids.cardStaffArrowSvg], "type": "Block", "data": { "tag": "span", "attr": { "data-bf-part": "card-arrow" } } },
    ...
    { "_id": ids.cardStaffBody, "tag": "div", "classes": c('bf-split-card-body'), "children": [ids.staffDynamic], "type": "Block", "data": { "tag": "div", "attr": { "data-bf-panel": "staff", "data-bf-part": "card-panel" } } },
    ...
    { "_id": ids.staffSample, "tag": "article", "classes": c('bf-template-item'), "children": [ids.staffSampleMain], "type": "Block", "data": { "tag": "article", "attr": { "data-bf-template": "staff-item", "data-bf-part": "staff-item" } } },
    { "_id": ids.staffSampleMain, "tag": "div", "classes": [], "children": [ids.staffSampleTitle, ids.staffSampleSub], "type": "Block", "data": { "tag": "div", "attr": { "data-bf-part": "staff-main" } } },
    { "_id": ids.staffSampleTitle, "tag": "h4", "classes": c('bf-template-item-title'), "children": [ids.staffSampleTitleText], "type": "Heading", "data": { "tag": "h4", "attr": { "data-bf-part": "staff-name" } } },
    { "_id": ids.staffSampleTitleText, "text": true, "v": "Naechstverfuegbaren" },
    { "_id": ids.staffSampleSub, "tag": "p", "classes": c('bf-template-item-sub'), "children": [ids.staffSampleSubText], "type": "Paragraph", "data": { "tag": "p", "attr": { "data-bf-part": "staff-desc" } } },
    { "_id": ids.staffSampleSubText, "text": true, "v": "Oder festen Mitarbeiter waehlen" },

    // Card: Addon
    { "_id": ids.cardAddon, "tag": "div", "classes": c('bf-split-card'), "children": [ids.cardAddonHeader, ids.cardAddonBody], "type": "Block", "data": { "tag": "article", "attr": { "data-bf-card": "addon", "data-bf-part": "card" } } },
    { "_id": ids.cardAddonHeader, "tag": "button", "classes": c('bf-split-card-header'), "children": [ids.cardAddonNum, ids.cardAddonInfo, ids.cardAddonArrow], "type": "Block", "data": { "tag": "button", "attr": { "type": "button", "aria-expanded": "false", "data-bf-part": "card-header" } } },
    { "_id": ids.cardAddonNum, "tag": "span", "classes": c('bf-split-card-num'), "children": [ids.cardAddonNumText], "type": "Block", "data": { "tag": "span", "attr": { "data-bf-part": "card-num" } } },
    { "_id": ids.cardAddonNumText, "text": true, "v": "4" },
    { "_id": ids.cardAddonInfo, "tag": "div", "classes": c('bf-split-card-info'), "children": [ids.cardAddonTitle, ids.cardAddonDesc], "type": "Block", "data": { "tag": "div", "attr": { "data-bf-part": "card-info" } } },
    { "_id": ids.cardAddonTitle, "tag": "h3", "classes": c('bf-split-card-title'), "children": [ids.cardAddonTitleText], "type": "Heading", "data": { "tag": "h3", "attr": { "data-bf-part": "card-title" } } },
    { "_id": ids.cardAddonTitleText, "text": true, "v": "Addon" },
    { "_id": ids.cardAddonDesc, "tag": "p", "classes": c('bf-split-card-desc'), "children": [ids.cardAddonDescText], "type": "Paragraph", "data": { "tag": "p", "attr": { "data-bf-part": "card-desc" } } },
    { "_id": ids.cardAddonDescText, "text": true, "v": "Extras hinzufügen" },
    { "_id": ids.cardAddonArrow, "tag": "span", "classes": c('bf-split-card-arrow'), "children": [ids.cardAddonArrowSvg], "type": "Block", "data": { "tag": "span", "attr": { "data-bf-part": "card-arrow" } } },
    ...
    { "_id": ids.cardAddonBody, "tag": "div", "classes": c('bf-split-card-body'), "children": [ids.guestCountBlock, ids.addonsDynamic], "type": "Block", "data": { "tag": "div", "attr": { "data-bf-panel": "addon", "data-bf-part": "card-panel" } } },
    ...
    { "_id": ids.guestCountMinus, "tag": "button", "classes": c('bf-qty-btn'), "children": [ids.guestCountMinusText], "type": "Block", "data": { "tag": "button", "attr": { "type": "button", "data-bf-action": "gc-minus" } } },
    ...
    { "_id": ids.guestCountPlus, "tag": "button", "classes": c('bf-qty-btn'), "children": [ids.guestCountPlusText], "type": "Block", "data": { "tag": "button", "attr": { "type": "button", "data-bf-action": "gc-plus" } } },
    ...
    { "_id": ids.addonsSample, "tag": "article", "classes": c('bf-template-item'), "children": [ids.addonsSampleMain, ids.addonsSamplePrice], "type": "Block", "data": { "tag": "article", "attr": { "data-bf-template": "addon-item", "data-bf-part": "addon-item" } } },
    { "_id": ids.addonsSampleMain, "tag": "h4", "classes": c('bf-template-item-title'), "children": [ids.addonsSampleMainText], "type": "Heading", "data": { "tag": "h4", "attr": { "data-bf-part": "addon-name" } } },
    { "_id": ids.addonsSampleMainText, "text": true, "v": "Beispiel Extra" },
    { "_id": ids.addonsSamplePrice, "tag": "p", "classes": c('bf-template-item-sub'), "children": [ids.addonsSamplePriceText], "type": "Paragraph", "data": { "tag": "p", "attr": { "data-bf-part": "addon-price" } } },
    { "_id": ids.addonsSamplePriceText, "text": true, "v": "+ EUR 15" },

    // -- RIGHT SIDE --
    { "_id": ids.splitRight, "tag": "aside", "classes": c('bf-split-right'), "children": [ids.calDynamic, ids.slotsDynamic, ids.dateInfoContainer], "type": "Block", "data": { "tag": "aside", "attr": { "data-bf-part": "split-right" } } },
    ...
    { "_id": ids.calSampleHeader, "tag": "h3", "classes": c('bf-template-item-title'), "children": [ids.calSampleHeaderText], "type": "Heading", "data": { "tag": "h3", "attr": { "data-bf-template": "calendar-header", "data-bf-part": "calendar-header" } } },
    { "_id": ids.calSampleHeaderText, "text": true, "v": "April 2026" },
    { "_id": ids.calSampleGrid, "tag": "div", "classes": c('bf-template-item'), "children": [ids.calSampleDay], "type": "Block", "data": { "tag": "div", "attr": { "data-bf-template": "calendar-day", "data-bf-part": "calendar-day" } } },
    { "_id": ids.calSampleDay, "tag": "button", "classes": c('bf-template-item-sub'), "children": [ids.calSampleDayText], "type": "Block", "data": { "tag": "button", "attr": { "type": "button", "disabled": "true", "data-bf-part": "calendar-day-button" } } },
    ...
    { "_id": ids.slotsSampleWrap, "tag": "article", "classes": c('bf-template-item'), "children": [ids.slotsSampleTitle, ids.slotsSampleDesc, ids.slotsSampleItem], "type": "Block", "data": { "tag": "article", "attr": { "data-bf-template": "timeslot-item", "data-bf-part": "timeslot-item" } } },
    { "_id": ids.slotsSampleTitle, "tag": "h3", "classes": c('bf-template-item-title'), "children": [ids.slotsSampleTitleText], "type": "Heading", "data": { "tag": "h3", "attr": { "data-bf-part": "timeslots-title" } } },
    { "_id": ids.slotsSampleTitleText, "text": true, "v": "Uhrzeit" },
    { "_id": ids.slotsSampleDesc, "tag": "p", "classes": c('bf-template-item-sub'), "children": [ids.slotsSampleDescText], "type": "Paragraph", "data": { "tag": "p", "attr": { "data-bf-part": "timeslots-desc" } } },
    { "_id": ids.slotsSampleDescText, "text": true, "v": "Waehle einen passenden Slot" },
    { "_id": ids.slotsSampleItem, "tag": "button", "classes": c('bf-template-item-sub'), "children": [ids.slotsSampleItemText], "type": "Block", "data": { "tag": "button", "attr": { "type": "button", "disabled": "true", "data-bf-part": "timeslot-button" } } },
    ...
    { "_id": ids.footer1Next, "tag": "button", "classes": c('bf-split-btn-next'), "children": [ids.footer1NextText], "type": "Block", "data": { "tag": "button", "attr": { "type": "button", "data-bf-action": "next", "data-bf-goto": "2" } } },
    ...
    { "_id": ids.step2LeftHeader, "tag": "header", "classes": c('bf-step2-header'), "children": [ids.step2Title, ids.step2Counter], "type": "Block", "data": { "tag": "header" } },
    ...
    { "_id": ids.voucherSection, "tag": "section", "classes": c('bf-step2-section'), "children": [ids.voucherHeader, ids.voucherRow], "type": "Block", "data": { "tag": "section" } },
    { "_id": ids.voucherHeader, "tag": "header", "classes": c('bf-step2-voucher-wrap'), "children": [ids.voucherLabel, ids.voucherHelp], "type": "Block", "data": { "tag": "header" } },
    { "_id": ids.voucherLabel, "tag": "h3", "classes": c('bf-label'), "children": [ids.voucherLabelText], "type": "Heading", "data": { "tag": "h3", "attr": { "data-bf-part": "voucher-title" } } },
    ...
    { "_id": ids.voucherBtn, "tag": "button", "classes": c('bf-btn-voucher'), "children": [ids.voucherBtnText], "type": "Block", "data": { "tag": "button", "attr": { "type": "button", "data-bf-action": "apply-voucher" } } },
    { "_id": ids.voucherBtnText, "text": true, "v": "Einlösen" },
    { "_id": ids.voucherStatus, "tag": "div", "classes": c('bf-voucher-status-box'), "children": [ids.voucherValid, ids.voucherInvalid, ids.voucherChecking], "type": "Block", "data": { "tag": "div", "attr": { "data-bf-display": "voucher-status", "data-bf-part": "voucher-status" } } },
    ...
    { "_id": ids.step2Right, "tag": "aside", "classes": c('bf-step2-right'), "children": [ids.summaryColumn], "type": "Block", "data": { "tag": "aside" } },
    ...
    { "_id": ids.summaryColumnHeader, "tag": "header", "classes": c('bf-step2-header'), "children": [ids.summaryColumnTitle], "type": "Block", "data": { "tag": "header" } },
    ...
    { "_id": ids.summaryDetailsWrap, "tag": "section", "classes": c('bf-step2-section'), "children": [ids.summaryDetails, ids.summaryDivider, ids.summaryPrices, ids.totalDisplay], "type": "Block", "data": { "tag": "section" } },
    { "_id": ids.summaryDetails, "tag": "dl", "classes": c('bf-step2-summary-wrap').concat(c('bf-summary-details')), "children": [ids.sumRowObject, ids.sumRowService, ids.sumRowAddon, ids.sumRowStaff, ids.sumRowGuests, ids.sumRowDate, ids.sumRowTime], "type": "Block", "data": { "tag": "dl", "attr": { "data-bf-dynamic": "summary-details" } } },
    { "_id": ids.sumRowObject, "tag": "div", "classes": c('bf-summary-row'), "children": [ids.sumRowObjectLabel, ids.sumRowObjectValue], "type": "Block", "data": { "tag": "div", "attr": { "data-bf-summary": "object", "data-bf-part": "summary-row" } } },
    { "_id": ids.sumRowObjectLabel, "tag": "dt", "classes": c('bf-summary-label'), "children": [ids.sumRowObjectLabelText], "type": "Block", "data": { "tag": "dt" } },
    { "_id": ids.sumRowObjectLabelText, "text": true, "v": "Objekt" },
    { "_id": ids.sumRowObjectValue, "tag": "dd", "classes": c('bf-summary-value'), "children": [], "type": "Block", "data": { "tag": "dd", "attr": { "data-bf-display": "summary-object", "data-bf-part": "summary-value" } } },
    { "_id": ids.sumRowService, "tag": "div", "classes": c('bf-summary-row'), "children": [ids.sumRowServiceLabel, ids.sumRowServiceValue], "type": "Block", "data": { "tag": "div", "attr": { "data-bf-summary": "service", "data-bf-part": "summary-row" } } },
    { "_id": ids.sumRowServiceLabel, "tag": "dt", "classes": c('bf-summary-label'), "children": [ids.sumRowServiceLabelText], "type": "Block", "data": { "tag": "dt" } },
    { "_id": ids.sumRowServiceLabelText, "text": true, "v": "Service" },
    { "_id": ids.sumRowServiceValue, "tag": "dd", "classes": c('bf-summary-value'), "children": [], "type": "Block", "data": { "tag": "dd", "attr": { "data-bf-display": "summary-service", "data-bf-part": "summary-value" } } },
    { "_id": ids.sumRowAddon, "tag": "div", "classes": c('bf-summary-row'), "children": [ids.sumRowAddonLabel, ids.sumRowAddonValue], "type": "Block", "data": { "tag": "div", "attr": { "data-bf-summary": "addon", "data-bf-part": "summary-row" } } },
    { "_id": ids.sumRowAddonLabel, "tag": "dt", "classes": c('bf-summary-label'), "children": [ids.sumRowAddonLabelText], "type": "Block", "data": { "tag": "dt" } },
    { "_id": ids.sumRowAddonLabelText, "text": true, "v": "Addon" },
    { "_id": ids.sumRowAddonValue, "tag": "dd", "classes": c('bf-summary-value'), "children": [], "type": "Block", "data": { "tag": "dd", "attr": { "data-bf-display": "summary-addon", "data-bf-part": "summary-value" } } },
    { "_id": ids.sumRowStaff, "tag": "div", "classes": c('bf-summary-row'), "children": [ids.sumRowStaffLabel, ids.sumRowStaffValue], "type": "Block", "data": { "tag": "div", "attr": { "data-bf-summary": "staff", "data-bf-part": "summary-row" } } },
    { "_id": ids.sumRowStaffLabel, "tag": "dt", "classes": c('bf-summary-label'), "children": [ids.sumRowStaffLabelText], "type": "Block", "data": { "tag": "dt" } },
    { "_id": ids.sumRowStaffLabelText, "text": true, "v": "Mitarbeiter" },
    { "_id": ids.sumRowStaffValue, "tag": "dd", "classes": c('bf-summary-value'), "children": [], "type": "Block", "data": { "tag": "dd", "attr": { "data-bf-display": "summary-staff", "data-bf-part": "summary-value" } } },
    { "_id": ids.sumRowGuests, "tag": "div", "classes": c('bf-summary-row'), "children": [ids.sumRowGuestsLabel, ids.sumRowGuestsValue], "type": "Block", "data": { "tag": "div", "attr": { "data-bf-summary": "guests", "data-bf-part": "summary-row" } } },
    { "_id": ids.sumRowGuestsLabel, "tag": "dt", "classes": c('bf-summary-label'), "children": [ids.sumRowGuestsLabelText], "type": "Block", "data": { "tag": "dt" } },
    { "_id": ids.sumRowGuestsLabelText, "text": true, "v": "Anzahl der Gäste" },
    { "_id": ids.sumRowGuestsValue, "tag": "dd", "classes": c('bf-summary-value'), "children": [], "type": "Block", "data": { "tag": "dd", "attr": { "data-bf-display": "summary-guests", "data-bf-part": "summary-value" } } },
    { "_id": ids.sumRowDate, "tag": "div", "classes": c('bf-summary-row'), "children": [ids.sumRowDateLabel, ids.sumRowDateValue], "type": "Block", "data": { "tag": "div", "attr": { "data-bf-summary": "date", "data-bf-part": "summary-row" } } },
    { "_id": ids.sumRowDateLabel, "tag": "dt", "classes": c('bf-summary-label'), "children": [ids.sumRowDateLabelText], "type": "Block", "data": { "tag": "dt" } },
    { "_id": ids.sumRowDateLabelText, "text": true, "v": "Datum" },
    { "_id": ids.sumRowDateValue, "tag": "dd", "classes": c('bf-summary-value'), "children": [], "type": "Block", "data": { "tag": "dd", "attr": { "data-bf-display": "summary-date", "data-bf-part": "summary-value" } } },
    { "_id": ids.sumRowTime, "tag": "div", "classes": c('bf-summary-row'), "children": [ids.sumRowTimeLabel, ids.sumRowTimeValue], "type": "Block", "data": { "tag": "div", "attr": { "data-bf-summary": "time", "data-bf-part": "summary-row" } } },
    { "_id": ids.sumRowTimeLabel, "tag": "dt", "classes": c('bf-summary-label'), "children": [ids.sumRowTimeLabelText], "type": "Block", "data": { "tag": "dt" } },
    { "_id": ids.sumRowTimeLabelText, "text": true, "v": "Uhrzeit" },
    { "_id": ids.sumRowTimeValue, "tag": "dd", "classes": c('bf-summary-value'), "children": [], "type": "Block", "data": { "tag": "dd", "attr": { "data-bf-display": "summary-time", "data-bf-part": "summary-value" } } },
    { "_id": ids.summaryDivider, "tag": "div", "classes": c('bf-summary-divider'), "children": [], "type": "Block", "data": { "tag": "div" } },
    { "_id": ids.summaryPrices, "tag": "dl", "classes": c('bf-step2-summary-wrap').concat(c('bf-price-rows')), "children": [ids.sumRowSubtotal, ids.sumRowDiscount, ids.sumRowTax, ids.priceRows], "type": "Block", "data": { "tag": "dl", "attr": { "data-bf-dynamic": "summary-prices" } } },
    { "_id": ids.sumRowSubtotal, "tag": "div", "classes": c('bf-summary-row-muted'), "children": [ids.sumRowSubtotalLabel, ids.sumRowSubtotalValue], "type": "Block", "data": { "tag": "div", "attr": { "data-bf-part": "summary-row-muted" } } },
    { "_id": ids.sumRowSubtotalLabel, "tag": "dt", "classes": c('bf-summary-label-muted'), "children": [ids.sumRowSubtotalLabelText], "type": "Block", "data": { "tag": "dt" } },
    { "_id": ids.sumRowSubtotalLabelText, "text": true, "v": "Subtotel" },
    { "_id": ids.sumRowSubtotalValue, "tag": "dd", "classes": c('bf-summary-value-muted'), "children": [], "type": "Block", "data": { "tag": "dd", "attr": { "data-bf-display": "summary-subtotal" } } },
    { "_id": ids.sumRowDiscount, "tag": "div", "classes": c('bf-summary-row-muted'), "children": [ids.sumRowDiscountLabel, ids.sumRowDiscountValue], "type": "Block", "data": { "tag": "div", "attr": { "data-bf-part": "summary-row-muted" } } },
    { "_id": ids.sumRowDiscountLabel, "tag": "dt", "classes": c('bf-summary-label-muted'), "children": [ids.sumRowDiscountLabelText], "type": "Block", "data": { "tag": "dt" } },
    { "_id": ids.sumRowDiscountLabelText, "text": true, "v": "Discount" },
    { "_id": ids.sumRowDiscountValue, "tag": "dd", "classes": c('bf-summary-value-muted'), "children": [], "type": "Block", "data": { "tag": "dd", "attr": { "data-bf-display": "summary-discount" } } },
    { "_id": ids.sumRowTax, "tag": "div", "classes": c('bf-summary-row-muted'), "children": [ids.sumRowTaxLabel, ids.sumRowTaxValue], "type": "Block", "data": { "tag": "div", "attr": { "data-bf-part": "summary-row-muted" } } },
    { "_id": ids.sumRowTaxLabel, "tag": "dt", "classes": c('bf-summary-label-muted'), "children": [ids.sumRowTaxLabelText], "type": "Block", "data": { "tag": "dt" } },
    { "_id": ids.sumRowTaxLabelText, "text": true, "v": "Steuer 19 %" },
    { "_id": ids.sumRowTaxValue, "tag": "dd", "classes": c('bf-summary-value-muted'), "children": [], "type": "Block", "data": { "tag": "dd", "attr": { "data-bf-display": "summary-tax" } } },
    { "_id": ids.priceRows, "tag": "div", "classes": [], "children": [], "type": "Block", "data": { "tag": "div", "attr": { "data-bf-dynamic": "price-rows", "data-bf-part": "price-rows", "style": "display: none;" } } },
    ...
    { "_id": ids.footer2Back, "tag": "button", "classes": c('bf-split-btn-back'), "children": [ids.footer2BackText], "type": "Block", "data": { "tag": "button", "attr": { "type": "button", "data-bf-action": "back", "data-bf-goto": "1" } } },
